...
Nsteps = 10000
dt = 0.01 # tune this for stable gradients
N = 256
L = 64 * np.pi
dx = L / N

# Initial conditions and variables
c = torch.full((Nsteps, N, N), 0.0, dtype=torch.float32, device=device)  # Start with a low base concentration

# Parameters for sphere generation
num_spheres = 1  # Number of spheres
min_radius = 1
max_radius = 100
c0_inside = 0.8  # Concentration inside the spheres
c0_outside = 0.2  # Concentration outside the spheres
spacing = 3  # Minimum spacing between spheres
